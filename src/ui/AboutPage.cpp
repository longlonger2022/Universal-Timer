    ...
    : QWidget(parent)
{
    ...
    AboutTextEdit = new QTextEdit(
        tr("欢迎使用万能倒计时！<br>"
            ...
            "这个程序最初只是为了满足2025届会考倒计时需求，后经过许多更新，走到了这里，截至该版本发布，已经有一年之多了。由于开发者的学业影响，该程序在匆忙中进行着并不大的“大”更新，可能并不完美甚至说不好用，还可能有许多bug。这一版本发布 (2026年5月16日) 后，为学业着想，将会有数十天的几乎不更新，而等到暂时摆脱影响之后，又几乎不再会线下前往亲手更新，故还请关注官网动向还有GitHub仓库，以获取最新的版本。同时，也欢迎来反馈！<br><br>"
            "注：编辑全屏提醒时间列表的界面已经没有时间写了，如果需要修改全屏提醒的时间列表，可以修改程序目录下的 reminder_time_list.txt，谢谢！"
